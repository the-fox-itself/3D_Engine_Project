...
//        double Ln3 = (plane.length*plane.distance*Math.sqrt(2)*(Math.sin(Math.abs(45-plane.rotation))+Math.sin(Math.abs(90-Math.abs(45-plane.rotation)))))/(2*(plane.distance+(plane.length*Math.sqrt(2))/2*Math.sin(Math.abs(45-plane.rotation))));
        ...
        double dLn1 = (plane.length*(Math.sin(90-plane.rotation)-Math.sin(plane.rotation)))/2;
        double dLn2 = (plane.length*(Math.sin(90-plane.rotation)+Math.sin(plane.rotation)))/(-2);
        double dLn3 = (plane.length*(Math.sin(90-plane.rotation)+Math.sin(plane.rotation)))/2;
